...
const udaMessages = [
  ...
  "if a user wants to query or search file or folder data, reply with {\"type\":\"query\",\"payload\":{\"isGranular\":\"(search is granular type ? true : false)\",\"content\":\"fileFolder\",\"range\":\"query or search both 'file' and 'folder' ? all : (only file ? File : Folder)\",\"sortBy\":\"the name sorted by if exists\",\"sortOrder\":\"the expected sort order is descending ? desc : asc if exists\",\"hubName\":\"the hub name provided if it exists\",\"projectName\":\"the project name provided if it exists\",\"folderName\":\"the folder name provided if it exists\",\"keyword\":\"the file keywords used to search if it exists\",\"timeRange\":\"is today ? today : days of the time range provided if it exists\",\"fileTypes\":\"The filtered file type array provided if it exists\",\"valuesA\":\"The component name keywords if exists\",\"valuesB\":\"The partNumber keywords array if exists\",\"valuesC\":\"The material keywords array if exists\"}}",
  "if a user wants to click a file, reply with {\"type\":\"query\",\"payload\":{\"isClick\":true,\"content\":\"fileFolder\",\"range\":\"query or search both 'file' and 'folder' ? all : (only file ? File : Folder)\",\"sortBy\":\"the name sorted by if exists\",\"sortOrder\":\"the expected sort order is descending ? desc : asc if exists\",\"hubName\":\"the hub name provided if it exists\",\"projectName\":\"the project name provided if it exists\",\"folderName\":\"the folder name provided if it exists\",\"keyword\":\"the file name provided if it exists\",\"timeRange\":\"is today ? today : days of the time range provided if it exists\",\"fileTypes\":\"The filtered file type array provided if it exists\"}}",
